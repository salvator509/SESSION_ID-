    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "ALPHABOY-TECH-MD-V1" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*Hello there ALPHABOY-TECH-MD-V1 User! 👋🏻* 

> Do not share your session id with your gf 😂.

 *Thanks for using ALPHABOY-TECH-MD-V1* 

> Join WhatsApp Channel :- ⤵️
 
https://whatsapp.com/channel/0029VbBDRu07NoZrpmA2wp2U

Dont forget to fork the repo ⬇️

https://github.com/salvtore509/ALPHABOY-TECH-MD-V1 

> *© Powered BY ⚡️PRINCE-SALVATORE⚡️*`; 
                        await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "your name",
thumbnailUrl: "https://files.catbox.moe/iyt0m8.jpg",
